      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
        <thead>
          <tr style={{ backgroundColor: '#f2f2f2' }}>
            ...
            <th style={{ border: '1px solid #ddd', padding: '8px' }}>Batter</th>
            <th style={{ border: '1px solid #ddd', padding: '8px' }}>Pitcher</th>
        ...
        <tbody>
          {events.map((event, index) => (
            <tr key={index} style={{ backgroundColor: index % 2 === 0 ? '#f8f8f8' : 'white' }}>
              ...
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{event.batter}</td>
              <td style={{ border: '1px solid #ddd', padding: '8px' }}>{event.pitcher}</td>
